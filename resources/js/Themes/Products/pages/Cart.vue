  ...
  <Layout>
    ...
    <div class="max-w-4xl mx-auto px-4 py-10">
        ...
        <div class="lg:col-span-2 space-y-4">
          <div v-for="item in cart.items" :key="item.id"
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-500 mt-1">{{ formatPrice(item.unit_price) }} each</p>
            </div>
      ...
      <div v-else class="text-center py-20">
        ...
        <Link :href="route('shop')" class="text-indigo-600 font-semibold hover:underline">Start Shopping →</Link>
      </div>
    </div>
  </Layout>
</template>
